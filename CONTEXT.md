...
> **Purpose:** This file captures ALL context needed to resume work on Pump Me. If you're a future Kit session with fresh context, read this file first.
>
...
**Pump Me** is a consumer-friendly GPU compute rental platform — "Airbnb for Compute."
...
| Product | Model | Description |
|---------|-------|-------------|
| **Pump White-Label** | Volume API | Partners rebrand Pump Me as their AI offering |
...
```
User Request → Pump Me Orchestrator → Provider Plugin (Vast/RunPod/Lambda/CoreWeave)
```
...
- One viral scandal ("deepfakes made on Pump Me") could kill us
...
- GitHub repo created: github.com/sneakyfree/PumpMe
