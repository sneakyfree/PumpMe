...
|---------|------|--------|-------|
| 0.1.1 | Register "Pump Me" LLC or Corp | ⏳ Grant | Waiting for Grant |
| 0.1.2 | Secure domain: pumpme.io | ⏳ Grant | Waiting for Grant |
| 0.1.3 | Create Pump Me email accounts | ⏳ | Depends on domain |
...
| 0.1.8 | Create Pump Me bank account | ⏳ Grant | Waiting for Grant |

### Step 0.2: Repository & DevOps Setup
| Task ID | Task | Status | Notes |
|---------|------|--------|-------|
| 0.2.1 | Create GitHub organization: PumpMe | ⏳ | Use sneakyfree/PumpMe for now |
| 0.2.2 | Create repo: pump-me-platform | ✅ | Monorepo structure created |
| 0.2.3 | Create repo: pump-me-docs | ⏳ | Can add docs/ later |
| 0.2.4 | Create repo: pump-me-infra | ⏳ | IaC can be added later |
